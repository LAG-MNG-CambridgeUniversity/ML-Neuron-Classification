...
data = np.loadtxt('C:/Users/Marius/Documents/GitHub/ML-Neuron-Classification/Datasets/testing/Combined_Data_ML.txt', dtype=np.float, delimiter=',')
...
print("The model corrects accurately in", model.evaluate(test_data, test_labels)[1], "%")